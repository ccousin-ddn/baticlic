...
**/
	require_once (dirname(__FILE__)."/../views/v_bil_account_lev2.php");
	
	class bil_account_lev2 extends bil_account_lev2_view {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->label 		= gettext("Compte de charge niv. 2");
			$this->labels 		= gettext("Comptes de charge niv. 2");
			$this->newtext		= gettext("Nouveau compte de charge niv. 2");
			$this->picto 		= '<i class="fal fa-list"></i>';
			$this->level		= 1;
