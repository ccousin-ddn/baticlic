<?php
    ...
    class import_xls{
		...
		public function showTable()
		{
			...
			$val_options = array(0=>"",1=>"Code Interne",2=>"Code Article",3=>"Désignation",4=>"Qté Log",5=>"Uni Cdt",6=>"Prix Net",7=>"Ecotax");
			$options = '';
				...
				<table id="set_fields" class="table table-striped" data-toggle="table" data-search="false">
					<thead>
						<tr>
							...
							<th><select name="col7" class="form-control selectpicker" data-dropup-auto="false" data-title="Colonne">'.$options.'</select></th>
							<th><select name="col8" class="form-control selectpicker" data-dropup-auto="false" data-title="Colonne">'.$options.'</select></th>
							<th><select name="col9" class="form-control selectpicker" data-dropup-auto="false" data-title="Colonne">'.$options.'</select></th>
							<th><select name="col10" class="form-control selectpicker" data-dropup-auto="false" data-title="Colonne">'.$options.'</select></th>
							<th><select name="col11" class="form-control selectpicker" data-dropup-auto="false" data-title="Colonne">'.$options.'</select></th>
						</tr>
					</thead>
					<tbody>
			';
