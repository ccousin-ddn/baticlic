...
**/
	require_once (dirname(__FILE__)."/../models/m_veh_insurance.php");
	
	class veh_insurance_view extends veh_insurance_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				//array("field"=>"idvehicle", "alter"=>"", "title"=>html("Véhicule"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"ins_insurer", "alter"=>"", "title"=>html("Assureur"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"ins_date_in", "alter"=>"date-be", "title"=>html("Date début"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortDate", "card-visible"=>"true"),
				array("field"=>"ins_date_out", "alter"=>"date-be", "title"=>html("Date fin"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortDate", "card-visible"=>"true"),
				array("field"=>"ins_year_amount", "alter"=>"euro", "title"=>html("Montant annuel"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortEuro", "card-visible"=>"true"),
				
			);
			$this->columns_edit = array(
				//array("field"=>"idvehicle", "alter"=>"", "title"=>html("Véhicule"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"ins_insurer", "alter"=>"", "title"=>html("Assureur"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"ins_date_in", "alter"=>"", "title"=>html("Date début"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortDate", "card-visible"=>"true"),
				array("field"=>"ins_date_out", "alter"=>"", "title"=>html("Date fin"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortDate", "card-visible"=>"true"),
				array("field"=>"ins_year_amount", "alter"=>"", "title"=>html("Montant annuel"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortEuro", "card-visible"=>"true"),
		...
		public function v_editLine()
		{
			...
			$this->values->ins_insurer = $input->create("text", "", "ins_insurer", false, "", "", "form-normal");
			$this->values->ins_date_in = $input->create("date", "", "ins_date_in", false, "", "", "text-left form-normal");
			$this->values->ins_date_out = $input->create("date", "", "ins_date_out", false, "", "", "text-left form-normal", array("horizontal"=>"right","vertical"=>"bottom"));
			$this->values->ins_year_amount = $input->create("text", "", "ins_year_amount", false, "", "col-md-6", "form-normal");
		...
		public function v_createCard($doc_document="")
		{
			// *** Input object ***
			$input = new input($this->values, $this->cryptfields);
			// info : input->create(type, label, name, mandatory(true/false)[, defaultValue[, divSize[, inputClass[, info(array)]]]]) ,"none-result-text"=>gettext("Créer le ins_name")
			...
			$inputs .= $input->create("select", gettext("Véhicule"), "idvehicle", false, "", "col-md-6", "", array("idlist"=>"1","table"=>"tableselect","search"=>"true","filterChild"=>null,"filtering"=>false));
			$inputs .= $input->create("text", gettext("Assureur"), "ins_insurer", false, "", "col-md-6");
			$inputs .= $input->create("date", gettext("Date début"), "ins_date_in", false, "", "col-md-3", "", array("horizontal"=>"right","vertical"=>"bottom"));
			$inputs .= $input->create("date", gettext("Date fin"), "ins_date_out", false, "", "col-md-3", "", array("horizontal"=>"right","vertical"=>"bottom"));
			$inputs .= $input->create("text", gettext("Montant annuel"), "ins_year_amount", false, "", "col-md-6");
			...
			// $tabs = $tab->create("Assurance", "underline ml-2", $forms);
		...
		public function v_createPdf($type)
		{
			...
			$pdf_name = gettext("")." ".$this->values->ins_name.'.pdf';
			
			$this->json['html'] = $pdfDoc->createPdf($this->values,$pdf_name,$type);
			$this->json['subject'] = gettext("")." ".$this->values->ins_name;
		}
