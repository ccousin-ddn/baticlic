...
**/
	require_once (dirname(__FILE__)."/../models/m_veh_brand.php");
	
	class veh_brand_view extends veh_brand_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"bra_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
				array("field"=>"bra_logo", "alter"=>"brand", "title"=>html("Logo"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "width"=>50),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", gettext("Dénomination"), "bra_name", false, "", "col-md-6");
			$inputs .= $input->create("uploadDrop", gettext("Logo"), "bra_logo", false, "", "col-md-4", "", array("table"=>$this->table,"type"=>"img","maxSize"=>"5","resize"=>":brandLogo/"));
		...
		public function v_createPdf($type)
		{
			...
			$pdf_name = gettext("")." ".$this->values->bra_name.'.pdf';
