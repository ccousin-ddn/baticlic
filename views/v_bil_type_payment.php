...
**/
	require_once (dirname(__FILE__)."/../models/m_bil_type_payment.php");
	
	class bil_type_payment_view extends bil_type_payment_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"typ_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
