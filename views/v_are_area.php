...
**/
	require_once (dirname(__FILE__)."/../models/m_are_area.php");
	
	class are_area_view extends are_area_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"are_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
				array("field"=>"are_min", "alter"=>"", "title"=>html("Distance Min."), "sortable"=>true, "searchable"=>false, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
				array("field"=>"are_max", "alter"=>"", "title"=>html("Distance Max."), "sortable"=>true, "searchable"=>false, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
				array("field"=>"are_amount", "alter"=>"", "title"=>html("Montant"), "sortable"=>true, "searchable"=>false, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", gettext("Dénomination"), "are_name", false, $this->dataSent['newValue']??"", "col-md-3");
			$inputs .= $input->create("text", gettext("Distance Min."), "are_min", false, "", "col-md-3");
			$inputs .= $input->create("text", gettext("Distance Max."), "are_max", false, "", "col-md-3");
			$inputs .= $input->create("text", gettext("Montant"), "are_amount", false, "", "col-md-3");
