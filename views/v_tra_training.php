...
**/
	require_once (dirname(__FILE__)."/../models/m_tra_training.php");
	
	class tra_training_view extends tra_training_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"tra_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"tra_description", "alter"=>"", "title"=>html("Description"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
				array("field"=>"tra_driving_licence", "alter"=>"", "title"=>html("Autorisation de conduite"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", gettext("Dénomination"), "tra_name", true, $this->dataSent['newValue']??"", "col-md-6");
			$inputs .= $input->create("radio", gettext("Autorisation de conduite"), "tra_driving_licence", false, "", "col-md-6", "", array("contents"=>$this->yesno));
			$inputs .= $input->create("textarea", gettext("Description"), "tra_description", false, "", "col-md-12", "", array("row"=>2));
