...
**/
	require_once (dirname(__FILE__)."/../models/m_wor_subcategory.php");
	
	class wor_subcategory_view extends wor_subcategory_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				//array("field"=>"idworsubcategory", "alter"=>"", "title"=>html("id"), "sortable"=>true, "searchable"=>false, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
				array("field"=>"cat_name", "alter"=>"", "title"=>html("Catégorie"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
				array("field"=>"subcat_code", "alter"=>"", "title"=>html("Code"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
		...
		public function v_createCard()
		{
			// *** Input object ***
			//dump($this->values);
			if($this->action=="newFrom"){
				$this->values->idworcategory = $this->dataSent['otherId'];
			}
			...
			$inputs = $input->create("select", "Catégorie", "idworcategory", true, $this->dataSent['otherId']??"", "col-md-12", "", array("idlist"=>"1","table"=>"wor_category","search"=>"true","filterChild"=>null,"none-result-text"=>"Créer la catégorie"));
			$inputs .= $input->create("text", "Code", "subcat_code", true, "", "col-md-3");
			$inputs .= $input->create("text", "Dénomination", "subcat_name", true, $this->dataSent['newValue']??"", "col-md-9");
			...
			// *** Title variable ***
			$title = $this->values->sub_name ?? gettext("Nouveau ".$this->label);
			// *** Page object ***
