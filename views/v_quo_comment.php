...
**/
	require_once (dirname(__FILE__)."/../models/m_quo_comment.php");
	
	class quo_comment_view extends quo_comment_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"com_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
				array("field"=>"com_remark", "alter"=>"", "title"=>html("Description"), "sortable"=>true, "searchable"=>true, "class"=>"text-break", "halign"=>"left", "align"=>"left"),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs = $input->create("text", "Dénomination", "com_name", false, "", "col-md-6");
			$inputs .= $input->create("textarea", "Description", "com_remark", false, "", "col-md-12", "", array("row"=>3));
			...
			// *** Title variable ***
			$title = $this->values->com_name ?? gettext("Nouveau ".$this->label);
			// *** Page object ***
