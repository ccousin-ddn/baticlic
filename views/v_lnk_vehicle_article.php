...
**/
	require_once (dirname(__FILE__)."/../models/m_lnk_vehicle_article.php");
	
	class lnk_vehicle_article_view extends lnk_vehicle_article_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				...
				array("field"=>"art_qty", "alter"=>"", "title"=>html("Qté"), "sortable"=>true, "searchable"=>true, "class"=>"text-break", "halign"=>"left", "align"=>"left"),
				array("field"=>"mvt_date_in", "alter"=>"date-be", "title"=>html("Date"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"sortDate"),
