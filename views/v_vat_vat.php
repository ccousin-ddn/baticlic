...
**/
	require_once (dirname(__FILE__)."/../models/m_vat_vat.php");
	
	class vat_vat_view extends vat_vat_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"vat_percent", "alter"=>"percent", "title"=>html("Taux"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", gettext("Taux"), "vat_percent", false, "", "col-md-6");
		...
		public function v_createPdf($type)
		{
			...
			$pdf_name = gettext("")." ".$this->values->vat_name.'.pdf';
