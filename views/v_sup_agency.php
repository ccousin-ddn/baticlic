...
**/
	require_once (dirname(__FILE__)."/../models/m_sup_agency.php");
	
	class sup_agency_view extends sup_agency_model {
		...
		public function __construct()
		{
			...
			$this->columns_edit = array(
				...
				array("field"=>"idsupplier", "alter"=>"", "title"=>html("Fournisseur"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
		...
		public function v_createCard($doc_document="")
		{
			...
			$page = new page("tr", "sup_agency_tr_".$this->idrecord, "", count($this->columns)+1, $body, $btn_save.$btn_cancel.$btn_delete);
