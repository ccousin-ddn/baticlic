...
**/
	require_once (dirname(__FILE__)."/../models/m_tas_type.php");
	
	class tas_type_view extends tas_type_model {
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs = $input->create("text", "Dénomination", "typ_name", false, "", "col-md-6");
