...
**/
	require_once (dirname(__FILE__)."/../models/m_bil_account_lev2.php");
	
	class bil_account_lev2_view extends bil_account_lev2_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"acc_name", "alter"=>"", "title"=>html("Charge niv. 2"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", "Charge niv. 2", "acc_name", true, $this->dataSent['newValue']??"", "col-md-9");
