...
**/
	require_once (dirname(__FILE__)."/../models/m_wor_category.php");
	
	class wor_category_view extends wor_category_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"cat_code", "alter"=>"", "title"=>html("Code"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
				...
				array("field"=>"met_name", "alter"=>"", "title"=>html("Métier"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
			);
		...
		public function v_createCard()
		{
			...
			$inputs = $input->create("text", "Code", "cat_code", true, "", "col-md-3");
			$inputs .= $input->create("text", "Dénomination", "cat_name", true, $this->dataSent['newValue']??"", "col-md-9");
			$inputs .= $input->create("select", "Métier", "cat_idmetier", true, "", "col-md-6", "", array("idlist"=>"1","table"=>"met_metier","search"=>"false","filterChild"=>null,"filtering"=>false));
			// *** Div object ***
			$div = new div();
