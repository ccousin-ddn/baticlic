...
**/
	require_once (dirname(__FILE__)."/../models/m_bil_account_lev3.php");
	
	class bil_account_lev3_view extends bil_account_lev3_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"acc_name", "alter"=>"", "title"=>html("Charge niv. 3"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>""),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", "Charge niv. 3", "acc_name", true, $this->dataSent['newValue']??"", "col-md-9");
