...
**/
	require_once (dirname(__FILE__)."/../models/m_cas_type.php");
	
	class cas_type_view extends cas_type_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"idcastype", "alter"=>"", "title"=>html("id"), "sortable"=>true, "searchable"=>false, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs = $input->create("text", "Dénomination", "typ_name", true, $this->dataSent['newValue']??"", "col-md-6");
