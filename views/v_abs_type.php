...
**/
	require_once (dirname(__FILE__)."/../models/m_abs_type.php");
	
	class abs_type_view extends abs_type_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"typ_code", "alter"=>"", "title"=>html("Code"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
				array("field"=>"typ_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
		...
		public function v_createCard($doc_document="")
		{
			...
			$inputs .= $input->create("text", "Dénomination", "typ_name", false, $this->dataSent['newValue']??"", "col-md-9");
