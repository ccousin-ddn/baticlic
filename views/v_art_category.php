...
**/
	require_once (dirname(__FILE__)."/../models/m_art_category.php");
	
	class art_category_view extends art_category_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"idartcategory", "alter"=>"", "title"=>html("idartcategory"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "width"=>"20"),
				array("field"=>"cat_code", "alter"=>"", "title"=>html("Code"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "width"=>"20"),
				array("field"=>"cat_num", "alter"=>"", "title"=>html("N°"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "width"=>"20"),
				array("field"=>"cat_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left"),
		...
		public function v_createCard($doc_document)
		{
			...
			$inputs = $input->create("text", "Code", "cat_code", true, "", "col-md-4");
			$inputs .= $input->create("text", "N°", "cat_num", false, "", "col-md-2");
			$inputs .= $input->create("text", "Dénomination", "cat_name", true, $this->dataSent['newValue']??"", "col-md-6");
			...
			// *** Title variable ***
			$title = $this->values->cat_name ?? gettext("Nouvelle ".$this->label);
			// *** Page object ***
			// info : new page(type, id, label, pageClass, body, buttons)
			$page = new page("modal", $this->table."_modal", $this->picto." ".$title, "no-scroll", $body, $btn_save.$btn_close.$btn_delete);
