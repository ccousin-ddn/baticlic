...
**/
	require_once (dirname(__FILE__)."/../models/m_ret_retention.php");
	
	class ret_retention_view extends ret_retention_model {
		...
		public function __construct()
		{
			...
			$this->columns = array(
				array("field"=>"ret_name", "alter"=>"", "title"=>html("Dénomination"), "sortable"=>true, "searchable"=>true, "class"=>"text-nowrap", "halign"=>"left", "align"=>"left", "sorter"=>"", "card-visible"=>"true"),
		...
		public function v_createCard($doc_document="")
		{
			// *** Input object ***
			$input = new input($this->values, $this->cryptfields);
			// info : input->create(type, label, name, mandatory(true/false)[, defaultValue[, divSize[, inputClass[, info(array)]]]]) ,"none-result-text"=>gettext("Créer le ret_name")
			...
			$inputs .= $input->create("text", gettext("Dénomination"), "ret_name", false, "", "col-md-6");
			...
			// $tabs = $tab->create("Retenue", "underline ml-2", $forms);
		...
		{
			//$type="view";
			$pdf_name = gettext("")." ".$this->values->ret_name;
