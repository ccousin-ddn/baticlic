class Webcam {
		constructor(webcamElement, facingMode = 'user', canvasElement = null, snapSoundElement = null) {
			...
			this._webcamElement.width = this._webcamElement.width || $(this._webcamElement).width();
			this._webcamElement.height = this._webcamElement.height || $(this._webcamElement).height();
