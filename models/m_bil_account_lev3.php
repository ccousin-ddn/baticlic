...
**/
	...
	class bil_account_lev3_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "bil_account_lev3";
			$this->key			= "idaccountlev3";
			$this->duplicateKey = false;
			
			$this->fields 		= "bil_account_lev3.*";
			...
			$this->conds 		= array();
			$this->groups 		= array();
			$this->orders 		= array("acc_name");
			$this->unset		= array();
			
			$this->fieldName	= "acc_name";
		...
		{
			$this->conds = array("idaccountlev3 = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idaccountlev3 AS id, acc_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
