...
**/
	...
	class cli_agency_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "cli_agency";
			$this->key			= "idcliagency";
			$this->duplicateKey = false;
			
			$this->fields 		= "cli_agency.*, CONCAT(cit_pc,' ',cit_name) AS cit_name";
		...
		{
			$this->conds = array("cli_agency.idcliagency = ".$idrecord);
			//$this->orders = array();
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "cli_agency.idcliagency AS id, age_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
