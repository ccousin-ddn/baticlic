...
**/
	...
	class abs_type_model extends crud {
		...
		{
			$this->conds = array("idabstype = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idabstype AS id, typ_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
