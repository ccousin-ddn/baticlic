...
**/
	...
	class bil_account_lev1_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "bil_account_lev1";
			$this->key			= "idaccountlev1";
			$this->duplicateKey = false;
			
			$this->fields 		= "bil_account_lev1.*";
		...
		{
			$this->conds = array("idaccountlev1 = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idaccountlev1 AS id, acc_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
