...
**/
	...
	class wor_medical_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "wor_medical";
			$this->key			= "idwormedical";
			$this->duplicateKey = false;
			
			$this->fields 		= "wor_medical.*, UNIX_TIMESTAMP(med_next_date) AS unix_next, wor_name";
		...
		{
			$this->conds = array("idwormedical = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idwormedical AS id, med_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
