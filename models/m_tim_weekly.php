...
**/
	...
	class tim_weekly_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "tim_weekly";
			$this->key			= "idtimweekly";
			$this->duplicateKey = false;
			
			$this->fields 		= "tim_weekly.*";
		...
		{
			$this->conds = array("idtimweekly = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idtimweekly AS id, wee_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
