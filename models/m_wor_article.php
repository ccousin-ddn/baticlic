...
**/
	...
	class wor_article_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "wor_article";
			$this->key			= "idworarticle";
			$this->duplicateKey = false;
			
			$this->fields 		= "wor_article.*, art_code, art_description, CONCAT_WS(' - ',CONCAT(art_code,' ',art_description),art_unit) AS art_name, art_price";
		...
		{
			$this->conds = array("wor_article.idworarticle = ".$idrecord);
			//$this->orders = array();
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "wor_article.idworarticle AS id, art_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
