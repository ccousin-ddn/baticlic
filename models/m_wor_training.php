...
**/
	...
	class wor_training_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "wor_training";
			$this->key			= "idwortraining";
			$this->duplicateKey = false;
			
			$this->fields 		= "wor_training.*, wor_name, tra_name";
			
			$this->joins 		= "
				LEFT JOIN wor_worker USING (idworker) 
				LEFT JOIN tra_training USING (idtraining) 
			";
			$this->conds 		= array();
			$this->groups 		= array();
			$this->orders 		= array();
		...
		{
			$this->conds = array("idwortraining = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idwortraining AS id, tra_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
