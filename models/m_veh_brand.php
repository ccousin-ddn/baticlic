...
**/
	...
	class veh_brand_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "veh_brand";
			$this->key			= "idvehbrand";
			$this->duplicateKey = false;
			
			$this->fields 		= "veh_brand.*";
			...
			$this->conds 		= array();
			$this->groups 		= array();
			$this->orders 		= array("bra_name");
			
			$this->unset		= array("idparent");
			$this->unclean		= array();
			
			/*** new from ***/
			$this->fieldName	= "bra_name";
		...
		{
			$this->conds = array("idvehbrand = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idvehbrand AS id, bra_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
