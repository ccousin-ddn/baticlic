...
**/
	...
	class sup_agency_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "sup_agency";
			$this->key			= "idsupagency";
			$this->duplicateKey = false;
			
			$this->fields 		= "sup_agency.*, CONCAT(cit_pc,' ',cit_name) AS cit_name";
			
			$this->joins 		= "
				LEFT JOIN cit_city ON idcity=age_idcity
			";
			$this->conds 		= array();
			$this->groups 		= array();
			$this->orders 		= array();
		...
		{
			$this->conds = array("sup_agency.idsupagency = ".$idrecord);
			//$this->orders = array();
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "sup_agency.idsupagency AS id, age_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
