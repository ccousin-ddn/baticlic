...
**/
	...
	class cit_city_model extends crud {
		...
		public function __construct()
		{
			...
			$this->conds 		= array();
			$this->groups 		= array();
			$this->orders 		= array('cit_pc','cit_name');
			
			$this->unset		= array("idparent");
			$this->unclean		= array();
			
			/*** new from ***/
			$this->fieldName	= "cit_name";
		...
		{
			$this->conds = array("idcity = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idcity AS id, CONCAT_WS(' ',cit_pc, cit_name) AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
