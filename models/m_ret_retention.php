...
**/
	...
	class ret_retention_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "ret_retention";
			$this->key			= "idretention";
			$this->duplicateKey = false;
			
			$this->fields 		= "ret_retention.*";
		...
		{
			$this->conds = array("ret_retention.idretention = ".$idrecord);
			//$this->orders = array();
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "ret_retention.idretention AS id, ret_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
