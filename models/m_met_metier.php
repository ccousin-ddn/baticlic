...
**/
	...
	class met_metier_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "met_metier";
			$this->key			= "idmetier";
			$this->duplicateKey = false;
			
			$this->fields 		= "met_metier.*";
		...
		{
			$this->conds = array("met_metier.idmetier = ".$idrecord);
			//$this->orders = array();
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "met_metier.idmetier AS id, met_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
