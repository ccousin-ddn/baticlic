...
**/
	...
	class art_category_model extends crud {
		...
		public function __construct()
		{
			...
			$this->key			= "idartcategory";
			$this->duplicateKey = false;
			
			$this->fields 		= "art_category.*";
		...
		{
			$this->conds = array("idartcategory = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idartcategory AS id, cat_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
