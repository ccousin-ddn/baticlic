...
**/
	...
	class bil_account_lev2_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "bil_account_lev2";
			$this->key			= "idaccountlev2";
			$this->duplicateKey = false;
			
			$this->fields 		= "bil_account_lev2.*";
		...
		{
			$this->conds = array("idaccountlev2 = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idaccountlev2 AS id, acc_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
