...
**/
	...
	class job_picture_model extends crud {
		
		public function __construct()
		{
			parent::__construct();
			
			$this->table 		= "job_picture";
			$this->key			= "idpicture";
			$this->duplicateKey = false;
			
			$this->fields 		= "job_picture.*";
		...
		{
			$this->conds = array("idpicture = ".$idrecord);
			//$this->orders = array();
			//$this->debugging = true;
		...
		public function m_getList($id, $conds=array())
		{
			$this->conds = $conds;
			switch($id){
				case 1 : $this->fields = "idpicture AS id, pic_name AS val, '' AS tokens"; $this->select(); break;
			}
			return true;
		}
